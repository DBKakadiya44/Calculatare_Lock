...
import com.db.calculatarelock.databinding.ActivityCreditCardBinding;
...
ActivityCreditCardBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int cnt = SplashScreenActivity.sharedPreferences.getInt("LpasCREDIT",0);
        ...
        binding.btnSave.setOnClickListener(view -> {
            ...
            if(!note1.equals("")){
                ...
                SplashScreenActivity.editor.putInt("LpasCREDIT",1);
    ...
    private void callAdapter() {
        ...
        CreditAdapter adapter = new CreditAdapter(CreditCardActivity.this,nn1,nn2,nn3,nn4);
        RecyclerView.LayoutManager manager = new LinearLayoutManager(CreditCardActivity.this);
