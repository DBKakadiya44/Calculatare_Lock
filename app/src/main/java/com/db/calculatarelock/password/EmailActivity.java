...
import com.db.calculatarelock.Adapter.EmailAdapter;
import com.db.calculatarelock.R;
import com.db.calculatarelock.SplashScreenActivity;
import com.db.calculatarelock.databinding.ActivityEmailBinding;
...
public class EmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int cnt = SplashScreenActivity.sharedPreferences.getInt("LpasEMAIL",0);
        ...
        binding.btnSave.setOnClickListener(view -> {
            ...
            if(!note1.equals("")){
                ...
                SplashScreenActivity.editor.putInt("LpasEMAIL",1);
    ...
    private void callAdapter() {
        ...
        EmailAdapter adapter = new EmailAdapter(EmailActivity.this,nn1,nn2,nn3);
        RecyclerView.LayoutManager manager = new LinearLayoutManager(EmailActivity.this);
