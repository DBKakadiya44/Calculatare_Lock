...
import com.db.calculatarelock.Adapter.PassportAdapter;
import com.db.calculatarelock.R;
import com.db.calculatarelock.SplashScreenActivity;
import com.db.calculatarelock.databinding.ActivityPassportBinding;
...
public class PassportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int cnt = SplashScreenActivity.sharedPreferences.getInt("LpasPASS", 0);
        ...
        binding.btnSave.setOnClickListener(view -> {
            ...
            if (!note1.equals("")) {
                ...
                SplashScreenActivity.editor.putInt("LpasPASS", 1);
    ...
    public static void saveArrayList1(Context context, ArrayList<String> arrayList) {
        ...
        SplashScreenActivity.editor.putString("pasPASS1", json);
    ...
    public static void saveArrayList2(Context context, ArrayList<String> arrayList) {
        Gson gson = new Gson();
        String json = gson.toJson(arrayList);
        SplashScreenActivity.editor.putString("pasPASS2", json);
        SplashScreenActivity.editor.apply();
    }

    public static ArrayList<String> getArrayList1(Context context) {
        String json = SplashScreenActivity.sharedPreferences.getString("pasPASS1", "");
        Gson gson = new Gson();
    ...
    public static ArrayList<String> getArrayList2(Context context) {
        String json = SplashScreenActivity.sharedPreferences.getString("pasPASS2", "");
        Gson gson = new Gson();
        Type type = new TypeToken<ArrayList<String>>() {
        }.getType();
        return gson.fromJson(json, type);
    ...
    private void callAdapter() {
        ...
        PassportAdapter adapter = new PassportAdapter(PassportActivity.this, nn1, nn2);
        RecyclerView.LayoutManager manager = new LinearLayoutManager(PassportActivity.this);
