...
import com.db.calculatarelock.databinding.ActivityIdCardBinding;
...
public class IdCardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int cnt = SplashScreenActivity.sharedPreferences.getInt("LpasID",0);
        ...
        binding.btnSave.setOnClickListener(view -> {
            ...
            if(!note1.equals("")){
                ...
                SplashScreenActivity.editor.putInt("LpasID",1);
    ...
    private void callAdapter() {
        ...
        IDAdapter adapter = new IDAdapter(IdCardActivity.this,nn1,nn2);
        RecyclerView.LayoutManager manager = new LinearLayoutManager(IdCardActivity.this);
